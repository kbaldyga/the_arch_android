		...
		mono.android.IGCUserPeer
{
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("thearch_android_test.SectorsAdapter, thearch_android_test, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", SectorsAdapter.class, __md_methods);
	}


	public SectorsAdapter (android.content.Context p0, int p1) throws java.lang.Throwable
	{
		super (p0, p1);
		if (getClass () == SectorsAdapter.class)
			mono.android.TypeManager.Activate ("thearch_android_test.SectorsAdapter, thearch_android_test, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "Android.Content.Context, Mono.Android, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065:System.Int32, mscorlib, Version=2.0.5.0, Culture=neutral, PublicKeyToken=7cec85d7bea7798e", this, new java.lang.Object[] { p0, p1 });
	}


	public SectorsAdapter (android.content.Context p0, int p1, int p2) throws java.lang.Throwable
	{
		super (p0, p1, p2);
		if (getClass () == SectorsAdapter.class)
	...
	public SectorsAdapter (android.content.Context p0, int p1, java.lang.Object[] p2) throws java.lang.Throwable
	{
		super (p0, p1, p2);
		if (getClass () == SectorsAdapter.class)
	...
	public SectorsAdapter (android.content.Context p0, int p1, int p2, java.lang.Object[] p3) throws java.lang.Throwable
	{
		super (p0, p1, p2, p3);
		if (getClass () == SectorsAdapter.class)
	...
	public SectorsAdapter (android.content.Context p0, int p1, java.util.List p2) throws java.lang.Throwable
	{
		super (p0, p1, p2);
		if (getClass () == SectorsAdapter.class)
	...
	public SectorsAdapter (android.content.Context p0, int p1, int p2, java.util.List p3) throws java.lang.Throwable
	{
		super (p0, p1, p2, p3);
		if (getClass () == SectorsAdapter.class)
